...
// Mon Nov 13 11:14:41 2023 by ROOT version 6.28/04
// from TTree data/Event Summary
// found on file: analysis_SUSYZHZToAllToAATo4B_M15.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           jet;
   Float_t         jet_px[9];   //[jet]
   Float_t         jet_py[9];   //[jet]
   Float_t         jet_pz[9];   //[jet]
   Float_t         jet_en[9];   //[jet]
   Float_t         jet_btag0[9];   //[jet]
   Float_t         jet_btag1[9];   //[jet]
   Float_t         jet_mass[9];   //[jet]
   Float_t         jet_area[9];   //[jet]
   Float_t         jet_pu[9];   //[jet]
   Float_t         jet_puId[9];   //[jet]
   Bool_t          jet_PFLoose[9];   //[jet]
   Bool_t          jet_PFTight[9];   //[jet]
   Int_t           jet_partonFlavour[9];   //[jet]
   Int_t           jet_hadronFlavour[9];   //[jet]
   Int_t           jet_mother_id[9];   //[jet]
   Float_t         jet_parton_px[9];   //[jet]
   Float_t         jet_parton_py[9];   //[jet]
   Float_t         jet_parton_pz[9];   //[jet]
   Float_t         jet_parton_en[9];   //[jet]
   Float_t         jet_genpt[9];   //[jet]
   Int_t           sv;
   Float_t         sv_px[13];   //[sv]
   Float_t         sv_py[13];   //[sv]
   Float_t         sv_pz[13];   //[sv]
   Float_t         sv_en[13];   //[sv]
   Int_t           sv_ntrk[13];   //[sv]
   Float_t         sv_dxy[13];   //[sv]
   Float_t         sv_dxyz[13];   //[sv]
   Float_t         sv_dxyz_signif[13];   //[sv]
   Float_t         sv_cos_dxyz_p[13];   //[sv]
   Float_t         sv_chi2[13];   //[sv]
   Float_t         sv_ndof[13];   //[sv]
   Int_t           sv_mc_nbh_moms[13];   //[sv]
   Int_t           sv_mc_nbh_daus[13];   //[sv]
   Int_t           fjet;
   Float_t         fjet_pt[5];   //[fjet]
   Float_t         fjet_px[5];   //[fjet]
   Float_t         fjet_py[5];   //[fjet]
   Float_t         fjet_pz[5];   //[fjet]
   Float_t         fjet_en[5];   //[fjet]
   Float_t         fjet_btag0[5];   //[fjet]
   Float_t         fjet_btag1[5];   //[fjet]
   Float_t         fjet_genpt[5];   //[fjet]
   Float_t         fjet_prunedM[5];   //[fjet]
   Float_t         fjet_softdropM[5];   //[fjet]
   Float_t         fjet_tau1[5];   //[fjet]
   Float_t         fjet_tau2[5];   //[fjet]
   Float_t         fjet_tau3[5];   //[fjet]
   Int_t           fjet_mother_id[5];   //[fjet]
   Float_t         fjet_parton_px[5];   //[fjet]
   Float_t         fjet_parton_py[5];   //[fjet]
   Float_t         fjet_parton_pz[5];   //[fjet]
   Float_t         fjet_parton_en[5];   //[fjet]
   Int_t           fjet_partonFlavour[5];   //[fjet]
   Int_t           fjet_hadronFlavour[5];   //[fjet]
   Int_t           fjet_subjet_count[5];   //[fjet]
   Float_t         fjet_subjets_px[5][2];   //[fjet]
   Float_t         fjet_subjets_py[5][2];   //[fjet]
   Float_t         fjet_subjets_pz[5][2];   //[fjet]
   Float_t         fjet_subjets_en[5][2];   //[fjet]
   Float_t         fjet_subjets_btag[5][2];   //[fjet]
   Float_t         imet_pt[11];
   Float_t         imet_phi[11];
   Float_t         met_pt;
   Float_t         met_phi;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("analysis_SUSYZHZToAllToAATo4B_M15.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("analysis_SUSYZHZToAllToAATo4B_M15.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("analysis_SUSYZHZToAllToAATo4B_M15.root:/mainNtuplizer");
